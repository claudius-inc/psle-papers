...
| Deploy pipeline protects SEO regressions | GitHub Pages build runs generate, local SEO audit, deploy, then live SEO audit | `.github/workflows/nuxtjs.yml`, `scripts/audit-pages-workflow.mjs`, `package.json`, live audit scripts, `SEO_RUNBOOK.md` | Run `25630048409` passed for commit `1ead198`; build, deploy, generated SEO audit, and live SEO audit all passed |
...
| --- | --- | --- |
| Improve website visibility | Sitemap, robots, canonical metadata, indexable landing and viewer pages | Latest fully verified deployment: run `25630048409` for commit `1ead198`; live sitemap, stale-snippet, JSON-LD, conversion, snippet, and OG image gates passed |
...
1. Latest fully verified deployment evidence is GitHub Actions run `25630048409` for commit `1ead1986e4ccf4f74ffa5bfbd58d7ea7a15879ba`, which passed build, deploy, generated SEO audit, and live SEO audits.
