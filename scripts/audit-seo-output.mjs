...
const deployableStaleCopyScript = readText("scripts/audit-deployable-stale-seo-copy.mjs");
...
for (const [file, snippet] of [
  ...
  [".output/public/exam-papers/2026-revision/index.html", 'href="/exam-papers/2025-primary-6-english"'],
  [".output/public/exam-papers/2026-revision/index.html", 'href="/exam-papers/2025-primary-6-chinese"'],
  [".output/public/exam-papers/2026-revision/index.html", 'href="/exam-papers/2025-primary-6-english-sa2"'],
  [".output/public/exam-papers/2026-revision/index.html", 'href="/exam-papers/2025-primary-6-chinese-sa2"'],
...
for (const snippet of [
  ...
  '"seo:stale-copy": "node scripts/audit-deployable-stale-seo-copy.mjs"',
...
for (const snippet of [
  ...
  "reports/seo/deployable-stale-seo-copy-audit.md",
  "2,200+Papers",
  "Anglo chinese School",
  "Methodist Girls' School (Primary)P6",
]) {
  if (!deployableStaleCopyScript.includes(snippet)) {
    fail(`Deployable stale SEO copy audit script is missing expected snippet: ${snippet}`);
  }
}
for (const snippet of [
  "Deployable Stale SEO Copy Audit",
  ...
  if (!deployableStaleCopyReport.includes(snippet)) {
    fail(`Deployable stale SEO copy audit report is missing expected snippet: ${snippet}`);
  }
}
for (const snippet of [
...
requireSourceSnippets("2026 revision page", revisionPage, [
  ...
  "trackRevisionCollectionClick",
  "/exam-papers/2025-primary-6-english",
  "/exam-papers/2025-primary-6-chinese",
  "/exam-papers/2025-primary-6-english-sa2",
  "/exam-papers/2025-primary-6-chinese-sa2",
